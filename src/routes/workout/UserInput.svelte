<script lang="ts">
    ...
    const handleUpload = async (files: FileList) =>{
        ...
        Array.from(files).forEach(async file => {
            ...
            const minio_response = await fetch('http://kazeserver.com:9500/flask/minio/upload_file', {
                method: 'POST',
                body: minio_formData
            });
            ...
            const database_response = await fetch('http://kazeserver.com:9500/flask/database/upload_video', {
                method: 'POST',
